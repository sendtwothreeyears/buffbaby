...
**Alternatives:**
- **Update existing skill** — If the learning directly relates to an existing skill in `.claude/skills/`
...
4. Place in `.claude/skills/` (project) or `~/.claude/skills/` (personal)
