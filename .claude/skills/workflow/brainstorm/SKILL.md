...
**Process knowledge:** See [techniques.md](techniques.md) for detailed question techniques, approach exploration patterns, and YAGNI principles.
...
- Read `.claude/subagents/repo-research-analyst.md`, then spawn a Task (subagent_type: "general-purpose") using its contents as the agent prompt. Pass: "Understand existing patterns related to: <feature_description>"
- Read `.claude/subagents/learnings-researcher.md`, then spawn a Task (subagent_type: "general-purpose", model: "haiku") using its contents as the agent prompt. Pass: "Find past solutions relevant to: <feature_description>"
...
**Guidelines (see [techniques.md](techniques.md) for detailed techniques):**
...
**Document structure:** See [techniques.md](techniques.md) for the template format. Key sections: What We're Building, Why This Approach, Key Decisions, Open Questions.
