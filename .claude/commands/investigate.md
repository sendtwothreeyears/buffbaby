...
**Usage:** `/investigate [bug description or symptom]`

**Example:** `/investigate push notifications not arriving for follow request approvals`
...
Spawn a Claude Opus subagent to synthesize findings (saves main thread tokens):
...
Write the synthesis to /tmp/investigate-synthesis.md
```
