...
**Usage:**
- `/user:team_three_review` — Review current branch with all six agents
- `/user:team_three_review [context]` — Review with additional context: `$ARGUMENTS`
...
Concatenate the canonical review commands with the context document. This keeps `code_review.md` and `code_review_critical.md` as the single source of truth.

```bash
# Standard prompt = canonical command + context
cat ~/.claude/commands/code_review.md > notes/.tmp/team-review-standard.md
echo -e "\n\n---\n\n**Additional Context:** $ARGUMENTS\n\n---\n\n# CONTEXT DOCUMENT\n" >> notes/.tmp/team-review-standard.md
cat notes/.tmp/team-review-context.md >> notes/.tmp/team-review-standard.md

# Critical prompt = canonical command + context
cat ~/.claude/commands/code_review_critical.md > notes/.tmp/team-review-critical.md
echo -e "\n\n---\n\n**Additional Context:** $ARGUMENTS\n\n---\n\n# CONTEXT DOCUMENT\n" >> notes/.tmp/team-review-critical.md
cat notes/.tmp/team-review-context.md >> notes/.tmp/team-review-critical.md
```

Note: The canonical commands specify output filenames:
